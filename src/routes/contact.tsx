        ...
        <div className="container-page">
            ...
            <SectionHeading
              ...
              title={
                <>
                  ...
                  <span className="text-gradient-brand">gestão da sua obra</span>
                </>
              }
          ...
          <div className="mx-auto mt-16 grid max-w-5xl gap-8 lg:grid-cols-[1fr_1.2fr]">
            <div className="space-y-6">
              {[
                { icon: Mail, t: "E-mail", d: "obralabs.oficial@gmail.com" },
                { icon: Phone, t: "Telefone", d: "+55 35 997803119" },
                { icon: MapPin, t: "Atuação", d: "Caraguatatuba, SP · Remoto" },
              ].map(({ icon: Icon, t, d }) => (
                <div
                  key={t}
                  className="flex items-start gap-4 rounded-2xl border border-border bg-card p-5 shadow-soft"
                >
                  <div className="grid h-11 w-11 place-items-center rounded-xl bg-[var(--ink)] text-primary">
              ...
              {sent ? (
                <div className="flex h-full flex-col items-center justify-center text-center">
                  ...
                  <p className="mt-2 text-muted-foreground">
                    A equipe da ObraLabs entrará em contato em breve.
                  </p>
                </div>
              ) : (
                <div className="space-y-5">
                  ...
                  <button
                    type="submit"
                    className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-primary px-6 py-3.5 text-sm font-semibold text-primary-foreground shadow-glow transition-transform hover:-translate-y-0.5"
                  >
